...
SWEP.ReloadHideBoneTables = {
    [1] = {"tag_clip", "tag_bullet_chambered_animate", "tag_bullet_deplete_sqtl_00_animate", "tag_bullet_mover_animate", "tag_bullet_deplete_sqtl_01_animate", "tag_bullet_deplete_sqtl_02_animate", "tag_bullet_deplete_sqtl_03_animate"},
}
